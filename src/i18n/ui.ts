...
const is = {
  ...
  footer: {
    ...
    cookiesLabel: 'Vefkökur',
    withdrawalLabel: 'Réttur til að falla frá samningi',
    /** The identification block lög nr. 30/2002, 6. gr., requires. */
    kennitala: 'Kt.',
    vsk: 'VSK-númer',
  },
  legal: {
    countingOn: 'Heimsóknartalning er á í þessum vafra.',
    countingOff: 'Slökkt er á heimsóknartalningu í þessum vafra.',
    turnCountingOff: 'Slökkva á talningu',
    turnCountingOn: 'Kveikja á talningu',
  },
  closer: {
...
const en: Ui = {
  ...
  footer: {
    ...
    kennitala: 'Company ID',
    vsk: 'VAT no.',
  },
  legal: {
    countingOn: 'Visit counting is on in this browser.',
    countingOff: 'Visit counting is off in this browser.',
    turnCountingOff: 'Switch counting off',
    turnCountingOn: 'Switch counting on',
  },
  closer: {
    line1: 'Tell us about',
    line2: 'your floor.',
...
const pl: Ui = {
  ...
  footer: {
    ...
    cookiesLabel: 'Pliki cookie',
    withdrawalLabel: 'Prawo odstąpienia od umowy',
    kennitala: 'Nr firmy',
    vsk: 'Nr VAT',
  },
  legal: {
    countingOn: 'Zliczanie wizyt jest włączone w tej przeglądarce.',
    countingOff: 'Zliczanie wizyt jest wyłączone w tej przeglądarce.',
    turnCountingOff: 'Wyłącz zliczanie',
    turnCountingOn: 'Włącz zliczanie',
  },
  closer: {
